...
beforeAll(async function (){
  try {
    ...
    insertedUser_section = await user_section.insertOne({
      user: '66ff252a87c6f40542fd9691',
      universe: 'scalable',
      location: 'violet',
      data: 'Loan',
      id: '66ff252a87c6f40542fd9692'
    });
    const user = dbInstance.collection('users');
    insertedUser = await user.insertOne({
      username: 'Genoveva96',
      password: '1RUmMSbeEidl5Es',
      email: 'Ericka.Schultz@gmail.com',
      name: 'Cory Senger',
      userType: 553,
      lastsection: '66ff252a87c6f40542fd96cf',
      mobileNo: '(959) 962-2555',
      resetPasswordLink: {},
      loginRetryLimit: 474,
      loginReactiveTime: '2025-06-22T02:51:48.946Z',
      id: '66ff252a87c6f40542fd96d0'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Mikel_Lebsack',
        'password':'288P_skP806g7dp',
        'email':'Daija_Bogan26@gmail.com',
        'name':'Ollie Heaney',
        'userType':authConstant.USER_TYPES.Admin,
        'lastsection':insertedUser_section.insertedId,
        'mobileNo':'(817) 183-2225',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Daija_Bogan26@gmail.com', });
