...
beforeAll(async function (){
  try {
    ...
    insertedUser_section = await user_section.insertOne({
      user: '66ff252a87c6f40542fd97b7',
      universe: 'invoice',
      location: 'Computer',
      data: 'Granite',
      id: '66ff252a87c6f40542fd97b8'
    });
    const user = dbInstance.collection('users');
    insertedUser = await user.insertOne({
      username: 'Lavada71',
      password: 'xpCwOIr1l53UvSX',
      email: 'Tremaine92@hotmail.com',
      name: 'Jonathon Kihn',
      userType: 314,
      lastsection: '66ff252a87c6f40542fd97f5',
      mobileNo: '(860) 586-5843',
      resetPasswordLink: {},
      loginRetryLimit: 345,
      loginReactiveTime: '2025-07-24T04:43:40.633Z',
      id: '66ff252a87c6f40542fd97f6'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Isom.Mante86',
        'password':'HZCN6MIZjnIGNSr',
        'email':'Jana51@hotmail.com',
        'name':'Dianna Koch',
        'userType':authConstant.USER_TYPES.User,
        'lastsection':insertedUser_section.insertedId,
        'mobileNo':'(112) 702-7986',
