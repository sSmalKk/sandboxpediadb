...
beforeAll(async function (){
  try {
    ...
    insertedUser_section = await user_section.insertOne({
      user: '66ff252a87c6f40542fd98dd',
      universe: 'COM',
      location: 'ADP',
      data: 'Tuna',
      id: '66ff252a87c6f40542fd98de'
    });
    const user = dbInstance.collection('users');
    insertedUser = await user.insertOne({
      username: 'Lia.Rempel52',
      password: 'MEJSmUOzH151Gcq',
      email: 'Jonatan39@hotmail.com',
      name: 'Marion Pollich',
      userType: 247,
      lastsection: '66ff252a87c6f40542fd991b',
      mobileNo: '(392) 036-8894',
      resetPasswordLink: {},
      loginRetryLimit: 875,
      loginReactiveTime: '2025-03-31T22:28:53.583Z',
      id: '66ff252a87c6f40542fd991c'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Karen6',
        'password':'BrK7CvJ69bRtzq6',
        'email':'Amanda.Cruickshank@yahoo.com',
        'name':'Cedric Ebert III',
        'userType':authConstant.USER_TYPES.User,
        'lastsection':insertedUser_section.insertedId,
        'mobileNo':'(395) 895-6887',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Amanda.Cruickshank@yahoo.com', });
